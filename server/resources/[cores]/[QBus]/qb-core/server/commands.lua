...
QBCore.Commands.Add("tp", "Teleport naar een speler of location", {{name="id/x", help="ID van een speler of X positie"}, {name="y", help="Y positie"}, {name="z", help="Z positie"}}, false, function(source, args)
	if (args[1] ~= nil and (args[2] == nil and args[3] == nil)) then
		...
		if args[1] ~= nil and args[2] ~= nil and args[3] ~= nil then
			...
			TriggerClientEvent('chatMessage', source, "Systeem", "error", "Niet elk argument is ingevuld (x, y, z)")
		end
	end
end, "admin")
...
QBCore.Commands.Add("dv", "Verwijder een voertuig", {}, false, function(source, args)
	TriggerClientEvent('QBCore:Command:DeleteVehicle', source)
end, "admin")

QBCore.Commands.Add("tpm", "Teleport naar locatie", {}, false, function(source, args)
