...
QBCore.Player.CheckPlayerData = function(source, PlayerData)
	...
	PlayerData.charinfo.account = PlayerData.charinfo.account ~= nil and PlayerData.charinfo.account or "NL0"..math.random(1,9).."INGB"..math.random(1111,9999)..math.random(1111,9999)..math.random(11,99)
